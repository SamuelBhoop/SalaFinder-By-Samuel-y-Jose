    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8">
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          <div className="mb-6">
            ...
            <input
              ...
              className={`w-full px-4 py-2.5 rounded-lg border text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 ${
                errors.password ? 'border-red-400 bg-red-50' : 'border-gray-300 focus:border-indigo-500'
              }`}
            />
            {errors.password && (
        ...
        <div className="mt-6 p-3 bg-gray-50 rounded-lg border border-gray-100">
          <p className="text-xs text-gray-500 text-center font-medium mb-1">Cuenta de demostración</p>
          <p className="text-xs text-gray-400 text-center">admin@salafinder.com / 123456</p>
        </div>
      </div>
    </div>
  )
